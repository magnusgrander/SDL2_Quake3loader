...
void CDebug::AddDebugLine(glm::vec3 vPoint1, glm::vec3 vPoint2)
{
...
void CDebug::AddDebugBox(glm::vec3 vCenter, float width, float height, float depth)
{
	...
	glm::vec3 vTopLeftFront( vCenter.x - width, vCenter.y + height, vCenter.z + depth);
	glm::vec3 vTopLeftBack(  vCenter.x - width, vCenter.y + height, vCenter.z - depth);
	glm::vec3 vTopRightBack( vCenter.x + width, vCenter.y + height, vCenter.z - depth);
	glm::vec3 vTopRightFront(vCenter.x + width, vCenter.y + height, vCenter.z + depth);

	glm::vec3 vBottom_LeftFront( vCenter.x - width, vCenter.y - height, vCenter.z + depth);
	glm::vec3 vBottom_LeftBack(  vCenter.x - width, vCenter.y - height, vCenter.z - depth);
	glm::vec3 vBottomRightBack( vCenter.x + width, vCenter.y - height, vCenter.z - depth);
	glm::vec3 vBottomRightFront(vCenter.x + width, vCenter.y - height, vCenter.z + depth);
